...
const AboutCTA = () => {
  return (
    <section className="relative mt-12 w-full overflow-hidden px-4 py-12 text-white md:px-8 md:py-14 lg:px-[80px]">
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight md:text-4xl">Partner with 100+ Trusted Pharmacies</h2>
