    ...
    <section className="px-[80px]">
      <div className="mt-12 pb-14">
        ...
        <p className="mt-3 w-full text-[14px] leading-7 text-slate-600">
          As we grow, our focus remains on verified quality, responsible pharmacy practices, and a user-friendly experience for both patients and
          partner pharmacies. Every improvement we build is aimed at making healthcare access more practical for everyday needs.
        </p>
      </div>
    </section>
  )
