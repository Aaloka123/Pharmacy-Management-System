...
const Header = () => {
  const baseLinkClass =
    'rounded-lg px-3.5 py-2 text-sm font-medium text-slate-700 transition duration-200 hover:text-teal-700'
      ...
      <nav className="flex w-full items-center justify-between">
        ...
        <div className="flex flex-1 items-center justify-end gap-3">
          <div className="relative hidden md:block">
            ...
            <input
              className="w-52 rounded-lg border border-slate-200 bg-slate-50 py-2 pl-9 pr-3 text-sm text-slate-700 outline-none transition duration-200 hover:border-slate-300 focus:border-teal-500 focus:bg-white"
              placeholder="Search..."
              type="text"
            />
          </div>
